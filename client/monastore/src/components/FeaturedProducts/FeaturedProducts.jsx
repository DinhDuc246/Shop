...
const FeaturedProducts = ({ type }) => {
    ...
    return (
        <div className='featuredProducts'>
            <div className="top">
                <h1>{type} products</h1>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi facilis adipisci provident nesciunt,
                    ad dolor tempore sunt ut dolorem eaque saepe perspiciatis vel exercitationem hic harum doloremque
                    odio error libero.</p>
            </div>
